...
export default function QARow(props:QARProps){
    return (
    <>
    <div className="bg-white w-1/1 mt-2 mb-2 p-5 text-2xl rounded-[5px] flex-column shrink-0 hover:scale-102 transition-[.4s] hover:shadow-violet-600/35 hover:shadow-xl">
